	...
	Repetir
		...
		Segun opcion Hacer
			...
			9: 
				...
				Escribir "";
				Escribir "Fernando Barrionuevo";
				Escribir "Maximiliano Chalin";
				Escribir "Pia Olivera";
				Escribir "Alicia Viviana Montenegro";
				Escribir "Juan Arce";
				Escribir "Sergio Dario Vega";
				Escribir "Giuliana Ayelen Pagano Alejos";
				Escribir "Alejandro Algarin";
				Escribir "";
...
Funcion generarVenta(matrizVendedor,matrizNrosVendedor,matrizProductos,matrizPySProductos,cantVend,cantProd) // Parámetros
	...
	//descuenta la cantidad de productos vendidos en la matriz
